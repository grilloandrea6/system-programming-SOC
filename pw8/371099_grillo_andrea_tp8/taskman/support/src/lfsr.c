...
void lfsr_fibonacci_glinit(struct lfsr_fibonacci *lfsr_fibonacci, unsigned nbits, lfsr_unsigned_t state, int xnor)
{
    assert(nbits >= 4 && nbits <= 64);
    lfsr_fibonacci_glinit2(lfsr_fibonacci, nbits, state, xnor, lfsr_feedbacks[nbits - 4]);
}

void lfsr_fibonacci_glinit2(struct lfsr_fibonacci *lfsr_fibonacci, unsigned nbits, lfsr_unsigned_t state, int xnor, lfsr_unsigned_t feedback)
{
