...
const myFloat FRAC_WIDTH = 0x40400000;
const myFloat CX_0 = 0xc0000000; 
const myFloat CY_0 = 0xbfc00000;
...
int main() {
   ...
   //float delta = FRAC_WIDTH / SCREEN_WIDTH; - - - - - - - - division not implemented
