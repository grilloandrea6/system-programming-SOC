...
int main() {
   ...
   draw_fractal(frameBuffer,SCREEN_WIDTH,SCREEN_HEIGHT,&calc_mandelbrot_point_soft, &iter_to_colour,floatToMyFloat(CX_0),floatToMyFloat(CY_0),floatToMyFloat(delta),N_MAX);
